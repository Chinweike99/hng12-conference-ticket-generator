...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-teal flex flex-col items-center py-8 px-4">
      {/* Navbar */}
      <nav className="w-full max-w-5xl z-50 flex rounded-xl fixed top-10 justify-between items-center mb-12 p-2 border border-white border-teal-500/40 backdrop-blur">
